...
class HoldingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create holding" do
    assert_difference('Holding.count') do
      post holdings_url, params: { holding: { shares: @holding.shares, stock_symbol: @holding.stock_symbol, user_id: @holding.user_id } }
    end
  ...
  test "should update holding" do
    patch holding_url(@holding), params: { holding: { shares: @holding.shares, stock_symbol: @holding.stock_symbol, user_id: @holding.user_id } }
